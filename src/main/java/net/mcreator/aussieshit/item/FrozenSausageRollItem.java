...
public class FrozenSausageRollItem extends AussieShitModElements.ModElement {
	@ObjectHolder("aussie_shit:frozen_sausage_roll")
	public static final Item block = null;
	public FrozenSausageRollItem(AussieShitModElements instance) {
		super(instance, 12);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("frozen_sausage_roll");
		}
