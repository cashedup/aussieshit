...
public class LighterItem extends AussieShitModElements.ModElement {
	@ObjectHolder("aussie_shit:lighter")
	public static final Item block = null;
	public LighterItem(AussieShitModElements instance) {
		super(instance, 1);
	}
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("Dont give it to a junkie"));
			}
			...
			public ActionResultType onItemUse(ItemUseContext context) {
				...
				ItemStack itemstack = context.getItem();
				{
					...
					LighterRightClickedOnBlockProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
			...
			public boolean hitEntity(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
				...
				World world = entity.world;
				{
					Map<String, Object> $_dependencies = new HashMap<>();
					$_dependencies.put("entity", entity);
					LighterLivingEntityIsHitWithToolProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
		}.setRegistryName("lighter"));
	}
