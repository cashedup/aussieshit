...
package net.mcreator.aussieshit.world.dimension;
...
public class ThesticksDimension extends AussieShitModElements.ModElement {
	@ObjectHolder("aussie_shit:thesticks_portal")
	public static final CustomPortalBlock portal = null;
	public ThesticksDimension(AussieShitModElements instance) {
		super(instance, 38);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("aussie_shit:thesticks"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("thesticks_portal", Vector3i::compareTo, 300);
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("thesticks_portal", Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())), 0, 1)
					.setRegistryName("thesticks_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new ThesticksItem().setRegistryName("thesticks"));
	}
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("aussie_shit:thesticks"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos, RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("aussie_shit:thesticks")));
				} else {
					entity.func_242279_ag();
	...
	public void onPlayerChangedDimensionEvent(PlayerEvent.PlayerChangedDimensionEvent event) {
		...
		if (event.getTo() == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("aussie_shit:thesticks"))) {
			{
				...
				ThesticksPlayerEntersDimensionProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
